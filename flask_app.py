...
def otchot():
    ...
    return send_file(file_path, as_attachment=True, download_name=f'report_{datetime.date.today()}.txt', mimetype='text')

@scheduler.task("cron", id="monday_job", week="*", day_of_week='mon', hour=0, minute=0)
def NewWeek():
    base.newWeek()
